#ifndef PRODUCERCONSUMERCOUNTINGSEMAPHORE_H
#define PRODUCERCONSUMERCOUNTINGSEMAPHORE_H

//include declarations
#include <iostream>
//#include <semaphore> //available in C++20
#include <mutex>
#include <thread>
#include <queue>
...
#if Cplusplus20
//namespace
namespace producerConsumerCountingSemaphore
{
    //MAX slots
